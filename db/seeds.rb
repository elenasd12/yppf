...
(0..9).each do |i|
  ...
  Expense.create(expenseid: "IDIDIDID", user_id: 1, expensetype: TYPE[i], frequency: "biweekly", projvalue: Faker::Commerce.price, actvalue: Faker::Commerce.price, percent: Faker::Number.number(2), month: 2, year: Date.today.year)
  Expense.create(expenseid: "IDIDIDID", user_id: 1, expensetype: TYPE[i], frequency: "biweekly", projvalue: Faker::Commerce.price, actvalue: Faker::Commerce.price, percent: Faker::Number.number(2), month: 3, year: Date.today.year)
  Expense.create(expenseid: "IDIDIDID", user_id: 1, expensetype: TYPE[i], frequency: "biweekly", projvalue: Faker::Commerce.price, actvalue: Faker::Commerce.price, percent: Faker::Number.number(2), month: 4, year: Date.today.year)
  Expense.create(expenseid: "IDIDIDID", user_id: 1, expensetype: TYPE[i], frequency: "biweekly", projvalue: Faker::Commerce.price, actvalue: Faker::Commerce.price, percent: Faker::Number.number(2), month: 5, year: Date.today.year)
  Expense.create(expenseid: "IDIDIDID", user_id: 1, expensetype: TYPE[i], frequency: "biweekly", projvalue: Faker::Commerce.price, actvalue: Faker::Commerce.price, percent: Faker::Number.number(2), month: 6, year: Date.today.year)
  Expense.create(expenseid: "IDIDIDID", user_id: 1, expensetype: TYPE[i], frequency: "biweekly", projvalue: Faker::Commerce.price, actvalue: Faker::Commerce.price, percent: Faker::Number.number(2), month: 7, year: Date.today.year)
  Expense.create(expenseid: "IDIDIDID", user_id: 1, expensetype: TYPE[i], frequency: "biweekly", projvalue: Faker::Commerce.price, actvalue: Faker::Commerce.price, percent: Faker::Number.number(2), month: 8, year: Date.today.year)
  Expense.create(expenseid: "IDIDIDID", user_id: 1, expensetype: TYPE[i], frequency: "biweekly", projvalue: Faker::Commerce.price, actvalue: Faker::Commerce.price, percent: Faker::Number.number(2), month: 9, year: Date.today.year)
  Expense.create(expenseid: "IDIDIDID", user_id: 1, expensetype: TYPE[i], frequency: "biweekly", projvalue: Faker::Commerce.price, actvalue: Faker::Commerce.price, percent: Faker::Number.number(2), month: 10, year: Date.today.year)
  Expense.create(expenseid: "IDIDIDID", user_id: 1, expensetype: TYPE[i], frequency: "biweekly", projvalue: Faker::Commerce.price, actvalue: Faker::Commerce.price, percent: Faker::Number.number(2), month: 11, year: Date.today.year)
  Expense.create(expenseid: "IDIDIDID", user_id: 1, expensetype: TYPE[i], frequency: "biweekly", projvalue: Faker::Commerce.price, actvalue: Faker::Commerce.price, percent: Faker::Number.number(2), month: 12, year: Date.today.year)
